...
setuptools.setup(
    ...
    description='Model governance AI for quant finance',
    license='Apache Software License',
    long_description=readme,
    long_description_content_type='text/markdown',
    install_requires=install_requires,
    url='https://github.com/compatibl/govern',
    project_urls={
        'Source Code': 'https://github.com/compatibl/govern',
    },
    packages=setuptools.find_packages(include=('govern', 'govern.*'), exclude=('tests', 'tests.*')),
    classifiers=[
